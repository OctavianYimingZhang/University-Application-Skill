...
const usTop: Array<[string, string, string, string, string, string, string, string]> = [
  ...
  ["uva", "University of Virginia", "UVA", "Undergraduate majors and minors", "https://www.virginia.edu/majors-minors/", "Graduate studies", "https://www.virginia.edu/graduate-studies/", "US News 2026 top-30 cutoff source list"],
  ...
  ["ucsd", "University of California, San Diego", "UC San Diego", "Undergraduate majors", "https://admissions.ucsd.edu/why/majors/index.html", "Graduate admissions programs", "https://grad.ucsd.edu/admissions/programs.html", "US News 2026 top-30 cutoff source list"],
